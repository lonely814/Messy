  ...
  (function(){
    ...
    function _ltAIPanel(inputEl,iconEl){
      ...
      document.getElementById("lt-ap-go").onclick=function(){
        ...
        var myGen=++_gen;
        fetch(api.url,{method:"POST",headers:{"Content-Type":"application/json","Authorization":"Bearer "+api.key},body:JSON.stringify({model:api.model||"deepseek-v4-flash",messages:[{role:"system",content:sys},{role:"user",content:text}],max_tokens:1000})})
