...
(function(){
    ...
    style.textContent = [
        ...
        '  display: none !important;',
        '}',
        'button[aria-label="会员超市"], button[class*="text-[#05A3C5]"] {',
        '  display: none !important;',
        '}',
        '[class*="bg-[#FAD6A4]"] {',
        '  display: none !important;',
        ...
        'div.b1280\\:max-w-\\[1440px\\] > div.block,',
        'div.b1280\\:max-w-\\[1440px\\] > div.hidden,',
        'div.b1280\\:max-w-\\[1440px\\] > div.mx-auto,',
        'div.b1280\\:max-w-\\[1440px\\] > div.mt-10,',
        'div.b1280\\:max-w-\\[1440px\\] > button.border-border-default {',
        '  display: none !important;',
        '}',

        /* ===== 首页-个人最近项目 ===== */
        'div.b768\\:mb-8:nth-of-type(4) {',
        '  width: 100% !important;',
        ...
        '}',
        'div.b768\\:mb-8:nth-of-type(4) > div.b768\\:mb-4 {',
        ...
        '  opacity: 1 !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) > div.b768\\:mb-4 div.b768\\:text-\\[18px\\] {',
        '  font-size: 22px !important;',
        '  font-weight: 600 !important;',
        '  letter-spacing: 0.3px !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.scrollbar-hide {',
        ...
        '}',
        '/* 开始创作卡片 */',
        'div.b768\\:mb-8:nth-of-type(4) div.aspect-video,',
        'div.b768\\:mb-8:nth-of-type(4) div.aspect-video > div.cursor-pointer {',
        '  width: 100% !important;',
        '  height: 320px !important;',
        '  max-width: 100% !important;',
        '  min-width: 0 !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.create-new-project-card {',
        '  width: 100% !important;',
        ...
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.create-new-project-card:hover {',
        '  background-color: rgba(38, 38, 38, 0.65) !important;',
        '  border-color: rgba(255, 255, 255, 0.25) !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.create-new-project-card div.text-fg-default {',
        ...
        '}',
        '/* 项目卡片 */',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto {',
        '  width: 100% !important;',
        '  height: 320px !important;',
        '  max-width: 100% !important;',
        '  min-width: 0 !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group {',
        '  width: 100% !important;',
        '  height: 100% !important;',
        '  border-radius: 16px !important;',
        ...
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group:hover {',
        '  transform: translateY(-4px) !important;',
        '  box-shadow: 0 16px 40px rgba(0, 0, 0, 0.5) !important;',
        '}',
        '/* 封面 */',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group > div:nth-of-type(1),',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.rounded-xl,',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.rounded-xl div.relative {',
        '  width: 100% !important;',
        '  height: 210px !important;',
        '  border-radius: 0 !important;',
        '}',
        '/* 底部信息 */',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.items-top {',
        '  width: 100% !important;',
        ...
        '  gap: 8px !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.items-top div.max-w-\\[calc\\(100\\%-34px\\)\\] {',
        '  width: 100% !important;',
        '  max-width: 100% !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.items-top p.text-fg-default {',
        ...
        '  overflow: hidden !important;',
        '}',
        'div.b768\\:mb-8:nth-of-type(4) div.md\\:w-auto div.group div.items-top p.text-xs {',
        '  font-size: 13px !important;',
        '  color: #888 !important;',
        '}',

        /* ===== 全部项目 - 容器 ===== */
        'div.b768\\:px-\\[10px\\] > div.mx-auto {',
        '  max-width: 1800px !important;',
        '  padding: 0 24px !important;',
        '  margin: 0 auto !important;',
        '}',
        '/* 面包屑导航 */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto > div.mb-6 {',
        '  margin: 28px 0 24px 0 !important;',
        '  justify-content: space-between !important;',
        '  align-items: center !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto > div.mb-6 div.text-base {',
        '  font-size: 24px !important;',
        '  font-weight: 600 !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto > div.mb-6 button.bg-btn-secondary {',
        ...
        '}',
        '/* 网格 */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 {',
        '  display: grid !important;',
        ...
        '  height: auto !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto input.hidden {',
        '  display: none !important;',
        '}',
        '/* "最近项目" 分区标题 */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3::before {',
        ...
        '}',
        '/* 开始创作卡片 - 280px */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.aspect-video {',
        '  width: 100% !important;',
        '  min-width: 0 !important;',
        '  height: 280px !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.create-new-project-card {',
        '  width: 100% !important;',
        '  height: 280px !important;',
        '  background-color: rgba(38, 38, 38, 0.4) !important;',
        '  border: 2px dashed rgba(255, 255, 255, 0.12) !important;',
        ...
        '  transition: all 0.3s ease !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.create-new-project-card:hover {',
        '  background-color: rgba(38, 38, 38, 0.65) !important;',
        '  border-color: rgba(255, 255, 255, 0.25) !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.create-new-project-card div.text-fg-default {',
        '  font-size: 16px !important;',
        '  text-align: center !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.create-new-project-card svg,',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.create-new-project-card div.py-2\\.5 p {',
        '  display: block !important;',
        '}',
        '/* 项目卡片 - 280px */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group {',
        '  border-radius: 16px !important;',
        '  overflow: hidden !important;',
        ...
        '  height: 280px !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:hover {',
        '  transform: translateY(-3px) !important;',
        '  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.5) !important;',
        '}',
        '/* 封面 - 170px */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group > div:nth-of-type(1) {',
        '  width: 100% !important;',
        '  height: 170px !important;',
        '  overflow: hidden !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.aspect-video {',
        '  width: 100% !important;',
        '  height: 170px !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group img {',
        '  width: 100% !important;',
        '  height: 100% !important;',
        '  object-fit: cover !important;',
        '}',
        '/* 底部信息 - 110px */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top {',
        '  width: 100% !important;',
        '  padding: 14px 16px !important;',
        '  height: 110px !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top p.text-fg-default {',
        '  font-size: 13px !important;',
        '  font-weight: 500 !important;',
        '  color: #eee !important;',
        ...
        '  -webkit-box-orient: vertical !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top p.text-xs {',
        '  font-size: 11px !important;',
        '  color: #888 !important;',
        '}',
        '/* 分割线 + "所有项目" 标题 */',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:nth-of-type(12) {',
        '  position: relative !important;',
        '}',
        'div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:nth-of-type(12)::after {',
...
'        _tInputs.forEach(function(inp){inp.oninput=_tRefresh;});',
        ...
        '          +\'<input type="text" id="ltp-set-url" placeholder="https://api.deepseek.com/chat/completions" value="\'+_ltEsc(api.url||"")+\'">\'',
        '          +\'<label style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:8px;display:block;">API Key</label>\'',
        '          +\'<input type="password" id="ltp-set-key" placeholder="sk-..." value="\'+_ltEsc(api.key||"")+\'">\'',
        '          +\'<label style="font-size:11px;color:rgba(255,255,255,0.4);margin-top:8px;display:block;">模型</label>\'',
        '          +\'<input type="text" id="ltp-set-model" placeholder="deepseek-v4-flash" value="\'+_ltEsc(api.model||"")+\'">\'',
        ...
        '          +\'<div style="margin-top:16px;border-top:1px solid rgba(129,140,248,0.12);padding-top:14px;">\'',
        '          +\'<div style="margin-bottom:8px;color:rgba(255,255,255,0.5);font-size:11px;">内容包（提示词 + 标签）</div>\'',
        '          +\'<div style="display:flex;gap:8px;">\'',
        '          +\'<button class="ltp-btn ltp-btn-primary" id="ltp-cp-export">导出内容包</button>\'',
        '          +\'<button class="ltp-btn ltp-btn-ghost" id="ltp-cp-import">导入内容包</button>\'',
        '          +\'</div></div>\';',
        ...
        '        };',
        '        document.getElementById("ltp-cp-export").onclick=function(){ _ltDownloadContentPack(); };',
        '        document.getElementById("ltp-cp-import").onclick=function(){ _ltImportContentPackFromFile(); };',
        '      }',
        '    }',
        '    var div=document.createElement("div");',
        '    div.id="libtv-prompt";',
        ...
        '  window._ltShowTagMenu=_ltShowTagMenu;',
                   '  console.log("[LibTV Boost] v1.8.3  · G网格 T性能 H隐藏 L连线 C全链 F搜索 P提示词 X专注 R直角 ?帮助 · AI增强 · DIY主题 · 画布配色 · 模板变量 · 标签 · 内容包");',
        '})();'
    ].join('\n');
    ...
    GM_registerMenuCommand('⤓ 导出内容包', function(){
        if(unsafeWindow._ltContent&&unsafeWindow._ltContent.exportPack) unsafeWindow._ltContent.exportPack();
    });
    GM_registerMenuCommand('⤒ 导入内容包', function(){
        if(unsafeWindow._ltContent&&unsafeWindow._ltContent.importFile) unsafeWindow._ltContent.importFile();
    });
