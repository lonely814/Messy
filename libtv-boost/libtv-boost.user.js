...
(function(){
    ...
    style.textContent = [
        ...
        '}',
        '/* 隐藏青色"会员超市"按钮 */',
        'body.libtv-clean-home button[aria-label="会员超市"],',
        'body.libtv-clean-home button[class*="text-[#05A3C5]"] {',
        '  display: none !important;',
        '}',
        '/* 隐藏Mantine图标按钮 */',
        'body.libtv-clean-home #mantine-y9su9myak-target {',
        '  display: none !important;',
        '}',
        '/* 隐藏额外的Mantine图标按钮 */',
        'body.libtv-clean-home #mantine-44x1mzccr-target {',
        '  display: none !important;',
        '}',
        '/* 隐藏"限时40折"徽章 */',
        'body.libtv-clean-home [class*="bg-[#FAD6A4]"] {',
        '  display: none !important;',
        '}',
        '/* 隐藏导航栏右侧文字div */',
        'body.libtv-clean-home div[class*="border-"][class*="topnav-btn-border"] > div.relative:first-child > div.relative:last-child {',
        '  display: none !important;',
        '}',
        '/* 画布背景：网格参考线 + 中心暖色辉光 */',
        '.react-flow__pane {',
        ...
        /* ===== 隐藏干扰元素 ===== */
        'body.libtv-clean-home header.m_3b16f56b > div.relative:first-child {',
        '  display: none !important;',
        '}',
        ...
        '  display: none !important;',
        '}',
        'body.libtv-clean-home #mantine-ycmieh2cx-target,',
        'body.libtv-clean-home #mantine-cdb8qursd-target,',
        ...
        '}',
        'body.libtv-clean-home div.b768\\:mb-8:nth-of-type(4) > div.b768\\:mb-4 {',
        ...
        '  opacity: 1 !important;',
        '}',
        'body.libtv-clean-home div.b768\\:mb-8:nth-of-type(4) > div.b768\\:mb-4 div.b768\\:text-\\[18px\\] {',
        ...
        '}',
        '/* 网格 */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 {',
        '  display: grid !important;',
        ...
        '}',
        '/* "最近项目" 分区标题 */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3::before {',
        ...
        '}',
        '/* 项目卡片 - 280px */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group {',
        '  border-radius: 16px !important;',
        '  overflow: hidden !important;',
        ...
        '  height: 280px !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:hover {',
        '  transform: translateY(-3px) !important;',
        '  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.5) !important;',
        '}',
        '/* 封面 - 170px */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group > div:nth-of-type(1) {',
        '  width: 100% !important;',
        '  height: 170px !important;',
        '  overflow: hidden !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.aspect-video {',
        '  width: 100% !important;',
        '  height: 170px !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group img {',
        '  width: 100% !important;',
        '  height: 100% !important;',
        '  object-fit: cover !important;',
        '}',
        '/* 底部信息 - 110px */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top {',
        '  width: 100% !important;',
        '  padding: 14px 16px !important;',
        '  height: 110px !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top p.text-fg-default {',
        '  font-size: 13px !important;',
        '  font-weight: 500 !important;',
        '  color: #eee !important;',
        ...
        '  -webkit-box-orient: vertical !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group div.items-top p.text-xs {',
        '  font-size: 11px !important;',
        '  color: #888 !important;',
        '}',
        '/* 分割线 + "所有项目" 标题 */',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:nth-of-type(12) {',
        '  position: relative !important;',
        '}',
        'body.libtv-clean-home div.b768\\:px-\\[10px\\] > div.mx-auto div.b768\\:grid-cols-3 > div.group:nth-of-type(12)::after {',
...
'        _ltRenderTheme();',
        ...
        '      +"<div class=\\\"lt-settings-about\\\">LibTV Canvas Boost v1.9.5<br>\\u6e90\\u7801\\u6a21\\u5757\\u5316\\u6784\\u5efa\\uff0c\\u63d0\\u4f9b\\u6027\\u80fd\\u4f18\\u5316\\u3001\\u89c6\\u89c9\\u589e\\u5f3a\\u3001AI \\u63d0\\u793a\\u8bcd\\u3001\\u6807\\u7b7e\\u7cfb\\u7edf</div>"',
        '      +"</div>";',
        '    h+="</div>";',
        '    div.innerHTML=h;',
        '    document.body.appendChild(div);',
        ...
        '  console.log("[LibTV Boost] v1.9.5  · G网格 T性能 H隐藏 L连线 C全链 F搜索 P提示词 X专注 R直角 ?帮助 · AI增强 · DIY主题 · 画布配色 · 模板变量 · 标签 · 内容包 · by oocc00");',
        '})();'
    ].join('\n');
    ...
    var _toggles = {
        ...
        clean: function(v){ document.body.classList.toggle('libtv-clean-home', v); },
    };
