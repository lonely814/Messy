...
(function(){
    ...
    style.textContent = [
        ...
        '}',
        '@keyframes libtv-tag-glow {',
        '  0%   { box-shadow: 0 0 4px rgba(255,0,255,0.35), 0 0 4px rgba(0,255,255,0.35), inset 0 0 3px rgba(255,255,255,0.2) !important; }',
        '  100% { box-shadow: 0 0 9px rgba(255,0,255,0.55), 0 0 9px rgba(0,255,255,0.55), inset 0 0 5px rgba(255,255,255,0.35) !important; }',
        '}',
        '.lt-tag-icon {',
        ...
        '  color:#fff;',
        '  opacity:0.85;',
        '  box-shadow:0 0 6px rgba(255,0,255,0.45),0 0 6px rgba(0,255,255,0.45),inset 0 0 4px rgba(255,255,255,0.25);',
        '  animation: libtv-tag-glow 4s ease-in-out infinite alternate !important;',
        '}',
        '.lt-tag-icon:hover {',
        '  opacity:1 !important;',
        '  box-shadow:0 0 11px rgba(255,0,255,0.75),0 0 11px rgba(0,255,255,0.75),inset 0 0 6px rgba(255,255,255,0.45) !important;',
        '}',
        '#libtv-pbtn:hover {',
...
'        _tInputs.forEach(function(inp){inp.oninput=_tRefresh;});',
        ...
        '      _ltRecentTags.slice(-10).reverse().forEach(function(t){var s=String(t).replace(/"/g,"&quot;");h+="<div class=\\"lt-tag-item\\" data-text=\\""+s+"\\" title=\\""+s+"\\">"+t+"</div>";});',
        '      h+="</div></div>";',
        '    }',
        '    (cat.groups||[]).forEach(function(g,gi){',
        '      h+="<div class=\\"lt-tag-group\\">";',
        '      h+="<div class=\\"lt-tag-group-head\\" data-gi=\\""+gi+"\\"><span class=\\"lt-tag-group-name\\">"+g.name+"</span><span class=\\"lt-tag-group-actions\\"><span class=\\"lt-tag-add-item\\" data-gi=\\""+gi+"\\" title=\\"新增标签\\">+</span><span class=\\"lt-tag-arrow "+(g.open?"open":"")+"\\">▾</span></span></div>";',
        '      if(g.open){',
        '        h+="<div class=\\"lt-tag-grid\\">";',
        '        (g.items||[]).forEach(function(it){var s=String(it).replace(/"/g,"&quot;");h+="<div class=\\"lt-tag-item\\" data-text=\\""+s+"\\" title=\\""+s+"\\">"+it+"</div>";});',
        '        h+="</div>";',
        '      }',
        '      h+="</div>";',
        '    });',
        ...
        '        if(ms.length){',
        '          found=true;',
        '          h+="<div class=\\"lt-tag-group\\"><div class=\\"lt-tag-group-head-static\\"><span class=\\"lt-tag-group-name\\">"+cat.name+" · "+g.name+"</span></div><div class=\\"lt-tag-grid\\">";',
        '          ms.forEach(function(it){var s=String(it).replace(/"/g,"&quot;");h+="<div class=\\"lt-tag-item\\" data-text=\\""+s+"\\" title=\\""+s+"\\">"+it+"</div>";});',
        '          h+="</div></div>";',
        '        }',
        '      });',
        '    });',
        ...
        '    h+="<div class=\\"lt-tag-grid\\">";',
        '    _ltRecentTags.slice().reverse().forEach(function(t){var s=String(t).replace(/"/g,"&quot;");h+="<div class=\\"lt-tag-item\\" data-text=\\""+s+"\\" title=\\""+s+"\\">"+t+"</div>";});',
        '    h+="</div>";',
        '    return h;',
        '  }',
        ...
        '    if(sel)sel.innerHTML=Object.keys(_ltTagLibs).map(function(n){return "<option value=\\""+n.replace(/"/g,"&quot;")+"\\""+(_ltCurLib===n?" selected":"")+">"+n+"</option>";}).join("");',
        '    var tabs=_ltTagMenuEl.querySelector("#lt-tag-tabs");',
        '    var th="";',
        '    cats.forEach(function(c,i){th+="<span class=\\"lt-tag-tab"+(i===_ltTagActiveCat?" active":"")+"\\" data-cat=\\""+i+"\\">"+(c.icon?c.icon+" ":"")+c.name+"</span>";});',
        ...
        '    var r=_ltTagInputEl.getBoundingClientRect(),mw=_ltTagMenuEl.offsetWidth||344,mh=_ltTagMenuEl.offsetHeight||420;',
        ...
        '            icon.style.cssText="position:absolute;right:6px;bottom:6px;z-index:2147483646;width:24px;height:24px;pointer-events:auto;border-radius:6px;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:opacity 0.15s,box-shadow 0.15s,background 0.15s;";',
        '',
        '',
        ...
        '  window._ltShowTagMenu=_ltShowTagMenu;',
         '  console.log("[LibTV Boost] v1.8 · G网格 T性能 H隐藏 L连线 C全链 F搜索 P提示词 X专注 R直角 ?帮助 · AI增强 · DIY主题 · 画布配色 · 模板变量 · 标签 · 内容包");',
        '})();'
    ].join('\n');
