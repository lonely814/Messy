...
'      /* 诊断：当前浮动图标状态 */',
'      _ltScanStats.icons=[];',
'      _ltScanStats.vp=window.innerWidth+"x"+window.innerHeight+" v"+"1.13.0";',
