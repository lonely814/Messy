...
| 版本          | 亮点                                                                                      |
| ----------- | --------------------------------------------------------------------------------------- |
| **v1.10.7** | 清爽模式重做：主页自动跳转项目页 · 拦截「回到主页/首页/logo」链接与 Mantine 下拉按钮 · 删除失效 CSS |
| **v1.10.6** | 浮动图标架构适配新版画布 · 双流光特效 · 卡片化设置面板与面板统一贵气化 · 图标诊断自检 · 健壮性修复 |
| **v1.10.5** | AI 配置面板大改：连接测试 · 多预设（默认 DeepSeek+本地 Llama）· 拉取模型 · 端点自动补全 · 面板拖拽                         |
